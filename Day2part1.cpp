...
int num=0;
int sum=0;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
while(getline(file,line)){//Rock=1, Paper=2, Scissors=3, Win=6, Draw=3 , Loss=0  //A and X=rock, B and Y=paper, C and Z=scissors
letter[0]=line[0];//stores the first character of the string  //ABC for player 1 XYZ for player2
